module Pulsar
  class CopyEnvironmentFile
    ...
    def validate_input!
      ...
      context.fail! error: "The application #{context.application} does not have an environment called #{context.environment}" unless context.applications[context.application].include? context.environment
    end
  end
end
